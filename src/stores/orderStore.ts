  ...
  orders: false ? [
    {
      ...
      customerEmail: 'amara.okafor@lagosclient.com',
      customerPhone: '+234 803 555 0192',
      shippingAddress: {
        fullName: 'Amara Okafor',
        email: 'amara.okafor@lagosclient.com',
  ...
  appointments: false ? [
    {
      ...
      guestEmail: 'amara.okafor@lagosclient.com',
      clientEmail: 'amara.okafor@lagosclient.com',
      guestPhone: '+234 803 555 0192',
      clientPhone: '+234 803 555 0192',
      serviceType: 'ATELIER_FITTING',
      appointmentType: 'IN_PERSON_FITTING',
      locationType: 'LAGOS_ATELIER',
      location: 'Finaluchi Flagship Atelier, Victoria Island, Lagos',
