...
export const CATEGORY_DEPARTMENTS: DepartmentCategory[] = [
  // --- PILLAR 1: TAILORING & SUITES ---
  {
    ...
    image: '/images/fc_luxury_pants.webp',
    galleryImages: [
      '/images/fc_luxury_pants.webp',
      '/images/fc_tailoring_suite.webp',
      '/images/fc_editorial_detail.webp',
    ],
  ...
  },
  {
    ...
    image: '/images/fc_luxury_shirt.webp',
    galleryImages: [
      '/images/fc_luxury_shirt.webp',
      '/images/fc_editorial_detail.webp',
      '/images/fc_tailoring_suite.webp',
    ],
    pillarGroup: 'TAILORING',
  ...
  },
  {
    ...
    slug: 'jackets',
    index: '03',
    tagline: 'Pagoda Shoulders & Waist Peplum',
    description: 'Structured tailoring with defined pagoda shoulders, sculpted lapels and cinched peplum waistlines. Crafted from pure Italian virgin wool and lined with breathable silk.',
    fabricProvenance: 'Italian Super 130s virgin wool & silk habotai lining',
    ...
    image: '/images/fc_tailoring_suite.webp',
    galleryImages: [
      '/images/fc_tailoring_suite.webp',
      '/images/fc_tailored_coat.webp',
      '/images/fc_atelier_craft.webp',
    ],
    pillarGroup: 'TAILORING',
    pillarLabel: 'Tailoring & Suites',
  },
  {
    id: '2PIECES',
    label: '2-Piece Suites',
    slug: '2pieces',
    index: '04',
    tagline: 'Harmonious Proportions & Modular Style',
    description: 'Calibrated two-piece ensembles matching cropped blazers with palazzo trousers or draped bustiers over knife-pleated skirts. Crafted for effortless coordination.',
    fabricProvenance: 'Hand-dyed silk crepe, wool matrix & pleated georgette',
    ...
    image: '/images/fc_bustier_pleated_skirt.webp',
    galleryImages: [
      '/images/fc_bustier_pleated_skirt.webp',
      '/images/fc_resort_solstice.webp',
      '/images/fc_editorial_detail.webp',
    ],
    pillarGroup: 'TAILORING',
    pillarLabel: 'Tailoring & Suites',
  ...
  {
    id: '3PIECES',
    label: '3-Piece Suites',
    slug: '3pieces',
    index: '05',
    tagline: 'The Zenith of Sovereign Tailoring',
    description: 'The definitive Finaluchi power statement. Double-breasted jacket, sculpted waistcoat and wide palazzo trousers tailored with floating horsehair canvas.',
    fabricProvenance: 'Super 150s virgin wool & mulberry silk canvas',
    ...
    image: '/images/fc_luxury_threepiece.webp',
    galleryImages: [
      '/images/fc_luxury_threepiece.webp',
      '/images/fc_tailored_coat.webp',
      '/images/fc_atelier_craft.webp',
      '/images/fc_editorial_detail.webp',
    ],
  ...
  // --- PILLAR 2: SILKS & EVENING GOWNS ---
  {
    ...
    image: '/images/fc_asymmetric_silk_dress.webp',
    galleryImages: [
      '/images/fc_asymmetric_silk_dress.webp',
      '/images/fc_editorial_monument.webp',
      '/images/fc_editorial_detail.webp',
    ],
    pillarGroup: 'SILKS',
  ...
  },
  {
    ...
    image: '/images/fc_haute_soiree_gown.webp',
    galleryImages: [
      '/images/fc_haute_soiree_gown.webp',
      '/images/fc_lapis_cape_gown.webp',
      '/images/fc_organza_cape_gown.webp',
      '/images/fc_atelier_craft.webp',
    ],
    pillarGroup: 'SILKS',
    pillarLabel: 'Silks & Gowns',
  },
  {
    ...
    image: '/images/fc_luxury_kimono.webp',
    galleryImages: [
      '/images/fc_luxury_kimono.webp',
      '/images/fc_atelier_craft.webp',
      '/images/fc_editorial_monument.webp',
    ],
    pillarGroup: 'SILKS',
  ...
  },
  {
    ...
    image: '/images/fc_resort_solstice.webp',
    galleryImages: [
      '/images/fc_resort_solstice.webp',
      '/images/fc_bustier_pleated_skirt.webp',
      '/images/fc_editorial_detail.webp',
  ...
  // --- PILLAR 3: SCULPTED & RESORT ---
  {
    ...
    image: '/images/fc_luxury_jumpsuit.webp',
    galleryImages: [
      '/images/fc_luxury_jumpsuit.webp',
      '/images/fc_editorial_detail.webp',
      '/images/fc_atelier_craft.webp',
    ],
  ...
  },
  {
    ...
    image: '/images/fc_editorial_detail.webp',
    galleryImages: [
      '/images/fc_editorial_detail.webp',
      '/images/fc_bustier_pleated_skirt.webp',
      '/images/fc_tailoring_suite.webp',
  ...
  },
  {
    ...
    image: '/images/fc_luxury_playsuit.webp',
    galleryImages: [
      '/images/fc_luxury_playsuit.webp',
      '/images/fc_tailored_coat.webp',
      '/images/fc_editorial_detail.webp',
    ],
    pillarGroup: 'SPECIALTY',
  ...
  },
  {
    ...
    image: '/images/fc_luxury_bikini.webp',
    galleryImages: [
      '/images/fc_luxury_bikini.webp',
      '/images/fc_resort_solstice.webp',
      '/images/fc_editorial_detail.webp',
    ],
    pillarGroup: 'SPECIALTY',
