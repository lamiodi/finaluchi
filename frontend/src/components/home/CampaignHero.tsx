...
export const CampaignHero: React.FC<CampaignHeroProps> = ({ onShopNow, onExploreAtelier }) => {
  ...
  const slides: HeroSlide[] = [
    {
      id: 'look-01',
      collectionCode: 'FINALUCHI',
      season: 'THE CAPSULE',
      category: 'READY-TO-WEAR',
      lookTitle: 'Occasion Gold',
      craftsmanship: 'Sequinned occasion dressing, shot on the Finaluchi client',
      imageUrl: '/images/campaign/hero-noir.jpeg',
      objectPositionDesktop: 'center 8%',
      objectPositionMobile: 'center 6%',
      pillar: 'DRESSES',
    },
    {
      id: 'look-02',
      collectionCode: 'SIGNATURE',
      season: 'HOUSE PRINTS',
      category: 'THE ROSSA DRESS',
      lookTitle: 'House Leopard, Rossa',
      craftsmanship: 'Shoulder rosette and asymmetric ruffle hem, sizes 6–16',
      imageUrl: '/images/products/rossa-dress/rossa-1.jpeg',
    ...
    {
      id: 'look-03',
      collectionCode: 'ONE-PIECE',
      season: 'CAPRI DRESSING',
      category: 'THE CLEO CAPRI',
      lookTitle: 'Cleo Capri Jumpsuit',
      craftsmanship: 'Plunging halter with the house leopard sash, sizes 6–14',
      imageUrl: '/images/products/cleo-capri-jumpsuit/cleo-1.jpeg',
      objectPositionDesktop: 'center 6%',
      objectPositionMobile: 'center 4%',
      pillar: 'JUMPSUITS',
    },
    {
      id: 'look-04',
      collectionCode: 'AT HOME',
      season: 'LOUNGE',
      category: 'THE LEONIE SET',
      lookTitle: 'Leonie Lounge 2 Piece',
      craftsmanship: 'Leopard jersey with red ribbon ties, sizes 10–16',
      imageUrl: '/images/products/leonie-capri-lounge-2-piece/leonie-3.jpeg',
      objectPositionDesktop: 'center 6%',
